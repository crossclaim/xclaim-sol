# A New Token Standard for Cryptocurrency-backed Tokens on Ethereum
**Note: Implementation provided for Bitcoin**

Token standard based on

**Issue, Trade, Redeem: Crossing Systems Bounds with Cryptocurrency-Backed Tokens**, Alexei Zamyatin and Dominik Harz and William J. Knottenbelt, *Cryptology ePrint Archive: Report 2018/643* URL https://eprint.iacr.org/2018/643.pdf

(Rest of README represents content from the ERC223 token standard by Dexaran)
